 ...
 * @version 1.0<br>
 * @taskId: <br>
 * @createDate 2019/11/28 15:54 <br>
 * @TODO 该类做什么？？
...
public class PayServiceImpl implements IPayService {
    ...
    public ServerResponse pay(Long orderNo, Long userId, String path) {
        ...
        log.info("支付订单，开始封装参数");
        //订单号 唯一
        resultMap.put("orderNo" , outTradeNo);
        // (必填) 订单标题，粗略描述用户的支付目的。如“xxx品牌xxx门店当面付扫码消费”
        String subject = new StringBuffer().append("newbie扫码支付，订单号：").append(order.getOrderNo()).toString();
        ...
        String body = new StringBuffer().append("订单：").append(order.getOrderNo()).append("; 共计金额：")
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(notifyUrl)//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置  回调地址
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String qrUrl = ftpPrefix+targetFile.getName();
